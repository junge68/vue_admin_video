			...
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="视频封面">
					<el-upload
					  ...
					  action="http://api.wushichaozhen.com/home/index/upload_image"
			...
			<el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="上传视频">
                  ...
                  <el-upload
                    ...
                    <video
                      v-if="addForm.url !='' && videoFlag == false"
                      :src="addForm.url"
                      width="350"
                      height="180"
                      controls="controls"
                    >您的浏览器不支持视频播放</video>    
                    <i
                      v-else-if="addForm.url =='' && videoFlag == false"
...
<script>
	import util from '../../common/js/util'
	 import { getUserList ,updataVideo ,deleteVideo,addvideo } from '../../api/api';
